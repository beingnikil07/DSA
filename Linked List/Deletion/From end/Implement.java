    ...
    public static class Linkedlist {
        ...
        void deleteLast() {
            if (head == null) {
                ...
                head = null;
                System.out.println("Only one node available in the list is deleted successfully");
                return;
            } else {
                Node temp = head;
                Node temp2 = null; // initialize initially as null
                while (temp.next != null) {
                    temp2 = temp;
                    temp = temp.next;
                }
                temp2.next = null;
                System.out.println(" Successfully Deleted node from the last");
            }
